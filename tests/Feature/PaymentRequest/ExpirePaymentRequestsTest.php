...
class ExpirePaymentRequestsTest extends TestCase
{
    ...
    private function paymentRequestCreatedHoursAgo(PaymentStatus $status, int $hoursAgo): PaymentRequest
    {
    ...
    {
        $stale = $this->paymentRequestCreatedHoursAgo(PaymentStatus::Pending, 49);
    ...
    {
        $fresh = $this->paymentRequestCreatedHoursAgo(PaymentStatus::Pending, 47);
    ...
    {
        $approved = $this->paymentRequestCreatedHoursAgo(PaymentStatus::Approved, 100);
        $rejected = $this->paymentRequestCreatedHoursAgo(PaymentStatus::Rejected, 100);
    ...
    {
        $this->paymentRequestCreatedHoursAgo(PaymentStatus::Pending, 50);
        $this->paymentRequestCreatedHoursAgo(PaymentStatus::Pending, 72);
        $this->paymentRequestCreatedHoursAgo(PaymentStatus::Pending, 10); // not stale
    ...
    public function test_a_request_exactly_at_the_48h_mark_is_not_yet_expired(): void
    {
        ...
        $boundary = $this->paymentRequestCreatedHoursAgo(PaymentStatus::Pending, 48);
    ...
    {
        $stale = $this->paymentRequestCreatedHoursAgo(PaymentStatus::Pending, 60);
